...
ORD_PARENS_OPEN = ord(b'(')
ORD_PARENS_CLOSE = ord(b')')

ORD_SQUARE_BRACKET_OPEN = ord(b'[')
ORD_SQUARE_BRACKET_CLOSE = ord(b']')

ORD_CURLY_BRACES_OPEN = ord(b'{')
ORD_CURLY_BRACES_CLOSE = ord(b'}')
