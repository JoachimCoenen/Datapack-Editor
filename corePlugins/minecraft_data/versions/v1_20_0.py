...
NAMES: list[str] = ['1.20', '1.20.1']


DATAPACK_VERSION: str = '15'
...
GAME_EVENTS: AbstractSet[ResourceLocation] = frozenset({
...
STRUCTURES: AbstractSet[ResourceLocation] = frozenset({
	ResourceLocation.fromString("String pillager_outpost"),
	ResourceLocation.fromString("String mineshaft"),
	ResourceLocation.fromString("String mineshaft_mesa"),
	ResourceLocation.fromString("String mansion"),
	ResourceLocation.fromString("String jungle_pyramid"),
	ResourceLocation.fromString("String desert_pyramid"),
	ResourceLocation.fromString("String igloo"),
	ResourceLocation.fromString("String shipwreck"),
	ResourceLocation.fromString("String shipwreck_beached"),
	ResourceLocation.fromString("String swamp_hut"),
	ResourceLocation.fromString("String stronghold"),
	ResourceLocation.fromString("String monument"),
	ResourceLocation.fromString("String ocean_ruin_cold"),
	ResourceLocation.fromString("String ocean_ruin_warm"),
	ResourceLocation.fromString("String fortress"),
	ResourceLocation.fromString("String nether_fossil"),
	ResourceLocation.fromString("String end_city"),
	ResourceLocation.fromString("String buried_treasure"),
	ResourceLocation.fromString("String bastion_remnant"),
	ResourceLocation.fromString("String village_plains"),
	ResourceLocation.fromString("String village_desert"),
	ResourceLocation.fromString("String village_savanna"),
	ResourceLocation.fromString("String village_snowy"),
	ResourceLocation.fromString("String village_taiga"),
	ResourceLocation.fromString("String ruined_portal"),
	ResourceLocation.fromString("String ruined_portal_desert"),
	ResourceLocation.fromString("String ruined_portal_jungle"),
	ResourceLocation.fromString("String ruined_portal_swamp"),
	ResourceLocation.fromString("String ruined_portal_mountain"),
	ResourceLocation.fromString("String ruined_portal_ocean"),
	ResourceLocation.fromString("String ruined_portal_nether"),
	ResourceLocation.fromString("String ancient_city"),
	ResourceLocation.fromString("String trail_ruins"),
})

# compiled from the Minecraft wiki:
SLOTS: Mapping[bytes, Optional[int]] = FrozenDict({
	b'armor.chest':     102,
	b'armor.feet':      100,
	b'armor.head':      103,
	b'armor.legs':      101,
