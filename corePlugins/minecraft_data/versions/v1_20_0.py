...
_VERSION_1_20_5 = replace(
	...
	attributes=frozenset({
		ResourceLocation.fromString('generic.armor'),
		ResourceLocation.fromString('generic.armor_toughness'),
		ResourceLocation.fromString('generic.attack_damage'),
		ResourceLocation.fromString('generic.attack_knockback'),
		ResourceLocation.fromString('generic.attack_speed'),
		ResourceLocation.fromString('generic.fall_damage_multiplier'),
		ResourceLocation.fromString('generic.flying_speed'),
		ResourceLocation.fromString('generic.follow_range'),
		ResourceLocation.fromString('generic.gravity'),
		ResourceLocation.fromString('generic.jump_strength'),
		ResourceLocation.fromString('generic.knockback_resistance'),
		ResourceLocation.fromString('generic.luck'),
		ResourceLocation.fromString('generic.max_absorption'),
		ResourceLocation.fromString('generic.max_health'),
		ResourceLocation.fromString('generic.movement_speed'),
		ResourceLocation.fromString('generic.safe_fall_distance'),
		ResourceLocation.fromString('generic.scale'),
		ResourceLocation.fromString('generic.step_height'),
		ResourceLocation.fromString('player.block_break_speed'),
		ResourceLocation.fromString('player.block_interaction_range'),
		ResourceLocation.fromString('player.entity_interaction_range'),
		ResourceLocation.fromString('zombie.spawn_reinforcements'),
	}),
	# compiled from the Minecraft wiki:
